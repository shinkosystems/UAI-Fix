...
const CalendarPage: React.FC = () => {
  ...
  const isInternal = ['gestor', 'planejista', 'orcamentista'].includes((userType || '').toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, ""));
  ...
  const fetchAgenda = async () => {
    try {
        ...
        const normType = role.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "");
       ...
       <div className="bg-white/80 backdrop-blur-md px-5 pt-12 pb-4 sticky top-0 z-20 border-b border-gray-200 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-500 text-[9px] font-black uppercase tracking-[0.2em]">{isInternal ? 'Visão Administrativa' : 'Minha Agenda'}</p>
                </div>
            </div>
                                ...
                                <div className="bg-cyan-50/50 p-3 rounded-2xl border border-cyan-100/50 space-y-2">
                                    ...
                                    <div className="flex items-start text-gray-700">
                                        ...
                                        <div>
                                            ...
                                            <span className="text-[9px] text-gray-500">{item.clienteData?.bairro}</span>
                                        </div>
                                    </div>
                                </div>
